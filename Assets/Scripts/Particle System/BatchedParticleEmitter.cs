...
namespace GrizzlyMachine
{
    public class BatchedParticleEmitter : MonoBehaviour
    {
        ...
        private BatchedParticleSystem particleSystem;
        ...
        public void Start()
        {
            var systems = GameObject.FindGameObjectsWithTag("Particle System");

            foreach(GameObject obj in systems)
            {
                if(obj.name == particleSystemName)
                {
                    particleSystem = obj.GetComponent<BatchedParticleSystem>();
                }
            }
        ...
        //{
        //    particleSystem._emitters.Remove(this);
        //}
    }
}