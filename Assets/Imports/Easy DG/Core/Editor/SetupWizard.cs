...
public class SetupWizard : EditorWindow {
    ...
    private string[] templateOptionsFSM = new string[] { "Few", "Some", "Many" };
    private string[] templateOptionsLMH = new string[] { "Low", "Medium", "High" };
    private string[] templateOptionsSML = new string[] { "Small", "Medium", "Large" };
